    ...
    <>
      <div className="fixed top-0 -z-10  h-full w-full items-center justify-center px-16 sm:flex overflow-hidden">
        <div className="relative h-full w-full">
          ...
          <div className="animation-delay-2000 absolute -right-4 top-0 h-72 w-72 animate-blob rounded-full bg-yellow-500 opacity-40 -mix-blend-multiply blur-xl filter"></div>
